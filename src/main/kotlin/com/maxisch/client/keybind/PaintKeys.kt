package com.maxisch.client.keybind
...
object PaintKeys {
    ...
    /** Flips the master switch. Turning it off also drops the live selection and brush arm and
     *  their overlays, leaving only the persistent painted blocks - re-enabling starts clean
     *  rather than resuming whatever was mid-flight. */
